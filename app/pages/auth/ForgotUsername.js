          ...
          <div className='relative w-full mb-3'>
            {state.showNextStep && (
              <div className='absolute z-10 flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3 rounded'>
                ...
                <div>
                  <p>Your username has been sent to your </p>
                  <p>email inbox at <span className='font-bold text-red-300'>{state.email.value}</span></p>
                  <p>Check your SPAM folder if you cannot locate the email in your regular inbox.</p>
                </div>
            ...
            <input onChange={e => dispatch({ type: 'emailImmediately', value: e.target.value })} id='email' autoComplete='off' className='shadow-inner appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500' id='email' type='text' />
