        ...
        <form onSubmit={handleSubmit} className='mx-auto shadow-sm lg:max-w-sm p-3 border lg:rounded-lg bg-white'>
          <div className='flex flex-wrap -mx-3 mt-1'>
            <div className='relative w-full px-3 mb-3'>
              ...
              <input onChange={e => dispatch({ type: 'usernameImmediately', value: e.target.value })} id='username' autoComplete='off' autoFocus spellCheck='false' className='appearance-none block w-full shadow-inner bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white' id='username' type='text' />
