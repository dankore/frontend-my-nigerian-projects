      ...
      <div className="px-2 max-w-sm mx-auto">
        <form className="p-3 sm:p-4 border rounded">
          <div className="mb-4">
            ...
            <input id="email" type="text" autoComplete="email" className="w-full py-3 px-4 appearance-none bg-gray-200 focus:outline-none focus:border-gray-500 focus:bg-white appearance-none border rounded py-1 px-3 text-gray-700 leading-tight" />
          </div>
          <div className="mb-4">
            ...
            <input id="password" type="password" autoComplete="current-password" className="w-full py-3 px-4 appearance-none bg-gray-200 focus:outline-none focus:border-gray-500 focus:bg-white appearance-none border rounded py-1 px-3 text-gray-700 leading-tight" />
          </div>
