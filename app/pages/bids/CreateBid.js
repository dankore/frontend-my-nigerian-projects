      ...
      <div className='-mt-6'>
        ...
        <form onSubmit={handleSubmitBid}>
          <div className='border border-gray-200 bg-white p-3 shadow-sm lg:rounded-lg'>
            ...
            <div className='flex justify-end'>
              <Link to={`/project/${state.projectId}`} className='cursor-pointer inline-flex shadow-sm mr-8 items-center justify-center px-4 py-2 border border-gray-400 text-base leading-6 font-medium rounded-md text-blue-600 bg-white hover:bg-gray-100 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out'>
