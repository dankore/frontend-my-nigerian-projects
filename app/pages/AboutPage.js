...
function About() {
  ...
  return (
    <Page margin='mx-2' title='About My Nigerian Projects'>
      ...
      <div className='mt-6 bg-white shadow-sm lg:rounded-lg py-6 px-4 sm:px-6 lg:px-8'>
          ...
          <li>
            <div className='flex'>
              ...
              <div className='ml-4'>
                ...
                <p className='mt-2 text-base leading-6 text-gray-500'>Make some money on the side by helping me accomplish my projects in Nigeria. Some of the projects I have done in the past include houses, shops, borehole, land purchase, and more. Check it out, I might have something for you. </p>
              </div>
            </div>
          </li>
