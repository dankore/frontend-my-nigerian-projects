  ...
  return (
    <Page margin='mx-2' title='Privacy'>
      <div className='flex justify-center my-20'>
        <svg style={{ width: 500 + 'px', height: 200 + 'px' }} id='fe35142f-6e52-48fa-b148-e7bb43d508cf' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' width='990' height='808.85706' viewBox='0 0 990 808.85706'>
      ...
      <h1 className='mt-12 text-base leading-6 text-blue-600 font-semibold tracking-wide uppercase'>The Bidding App Privacy Policy</h1>
      <div className='mt-4 relative z-10 leading-normal'>
        <p>
