...
function Terms() {
  return (
    <Page margin='mx-2' title='Terms'>
     ...
     <div className="relative z-10 leading-normal w-full max-w-md bg-white p-4 md:p-8 mx-auto shadow-md"><h3 className="mb-4">Overview</h3><p className="mt-4">Thank you for stopping by!</p><p className="mt-4">This website is operated by The Bidding App. Throughout the site, the
      terms “we”, “I”, “us”, “our”, and “Website” refer to The Bidding App. The Bidding App offers this website, including all information, tools and services
      available from this site to you, the user, conditioned upon your
      acceptance of all terms, conditions, policies and notices stated here.</p><p className="mt-4">By visiting our site and / or purchasing something from us and other users, you engage in
      our “Service” and agree to be bound by the following terms and
      conditions(“Terms of Service”, “Terms”), including those additional terms
      ...
      Merchants, and / or contributors of content.</p><p className="mt-4">Please read these Terms of Service carefully before accessing or using our
      ...
      is expressly limited to these Terms of Service.</p><p className="mt-4"><b>LICENSE:</b> In these Website Standard Terms And Conditions, “Your Content” shall mean any audio, video, text, images or other material you choose to display on this Website. With respect to Your Content, by displaying it, you grant The Bidding App a non-exclusive, worldwide, irrevocable, royalty-free, sub licensable license to use, reproduce, adapt, publish, translate and distribute it in any and all media.
      Your Content must be your own and must not be infringing on any third party’s rights. The Bidding App reserves the right to remove any of Your Content from this Website at any time, and for any reason, without notice.</p><p className="mt-4"><b>NO WARRANTIES:</b> This Website is provided “as is,” with all faults, and The Bidding App makes no express or implied representations or warranties, of any kind related to this Website or the materials contained on this Website. Additionally, nothing contained on this Website shall be construed as providing consult or advice to you.</p><p className="mt-4">Any new features or tools which are added to the current store shall also
      ...
      those changes.</p><h3 className="mt-8 mb-4">SECTION 1 - ONLINE STORE TERMS</h3><p className="mt-4">By agreeing to these Terms of Service, you represent that you are at least
      the age of maturity in your state or province of residence, and you
      have given us your consent to allow any of your minor dependents to use
      this site. If you are under the age of eighteen (18), you represent that a parent or legal guardian also agrees to this section on your behalf. You may not use our products for any illegal or unauthorized
      ...
      termination of your Services.</p><h3 className="mt-8 mb-4">SECTION 2 - GENERAL CONDITIONS</h3><p className="mt-4">We reserve the right to refuse service to anyone for any reason at any
      ...
      always encrypted during transfer over networks.</p><p className="mt-4">You agree not to reproduce, duplicate, copy, sell, resell or exploit any
      ...
      Terms.</p><h3 className="mt-8 mb-4">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h3><p className="mt-4">We are not responsible if information made available on this site is not
      ...
      material on this site is at your own risk.</p><p className="mt-4">This site may contain certain historical information. Historical
      ...
      site.</p><h3 className="mt-8 mb-4">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h3><ul><li className="mt-3">Prices for our products are subject to change without notice.</li><li className="mt-3">We reserve the right at any time to modify or discontinue the Service(or
        any part or content thereof) without notice at any time.</li><li className="mt-3">We shall not be liable to you or to any third - party for any
        modification, price change, suspension or discontinuance of the Service.</li></ul><h3 className="mt-8 mb-4">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h3><p className="mt-4">Certain products or services may be available exclusively online through
      ...
      your computer monitor 's display of any color will be accurate.</p><p className="mt-4">We reserve the right, but are not obligated, to limit the sales of our
      ...
      service made on this site is void where prohibited.</p><p className="mt-4">We do not warrant that the quality of any products, services, information,
      or other material purchased or obtained by you will meet your
      expectations, or that any errors in the Service will be corrected.</p><h3 className="mt-8 mb-4">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h3><p className="mt-4">We reserve the right to refuse any order you place with us. We may, in our
      ...
      under the same customer account, the same credit card, and / or orders
      ...
      resellers or distributors.</p><p className="mt-4">You agree to provide current, complete and accurate purchase and account
      ...
      transactions and contact you as needed. For more detail, please review our
      Returns Policy.</p><h3 className="mt-8 mb-4">SECTION 7 - OPTIONAL TOOLS</h3><p className="mt-4">We may provide you with access to third-party tools over which we neither
      ...
      endorsement. We shall have no liability whatsoever arising from or relating
      ...
      and you should ensure that you are familiar with and approve of the terms
      on which tools are provided by the relevant third - party provider(s).</p><p className="mt-4">We may also, in the future, offer new services and/or features through the
      ...
      Service.</p><h3 className="mt-8 mb-4">SECTION 8 - THIRD - PARTY LINKS</h3><p className="mt-4">Certain content, products and services available via our Service may
      ...
      or services of third - parties.</p><p className="mt-4">We are not liable for any harm or damages related to the purchase or use
      ...
      third-party.</p><h3 className="mt-8 mb-4">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h3><p className="mt-4">If, at our request, you send certain specific submissions( for example
      ...
      you forward to us. We are and shall be under no obligation:</p><ul><li className="mt-3">to maintain any comments in confidence;</li><li className="mt-3">to pay compensation for any comments; or</li><li className="mt-3">to respond to any comments.</li></ul><p className="mt-4">We may, but have no obligation to, monitor, edit or remove content that we
      ...
      violates any party’ s intellectual property or these Terms of Service.</p><p className="mt-4">You agree that your comments will not violate any right of any third -
      ...
      affect the operation of the Service or any related website. You may not use
      a false e - mail address, pretend to be someone other than yourself, or
      ...
      comments posted by you or any third-party.</p><h3 className="mt-8 mb-4">SECTION 10 - PERSONAL INFORMATION</h3><p className="mt-4">Your submission of personal information through the store is governed by
      our<Link className="text-blue-dark" href="/privacy"> Privacy Policy</Link>.</p><h3 className="mt-8 mb-4">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h3><p className="mt-4">Occasionally there may be information on our site or in the Service that
      ...
      have submitted your order).</p><p className="mt-4">We undertake no obligation to update, amend or clarify information in the
      ...
      been modified or updated.</p><h3 className="mt-8 mb-4">SECTION 12 - PROHIBITED USES</h3><p className="mt-4">In addition to other prohibitions as set forth in the Terms of Service,
      you are prohibited from using the site or its content:</p><ul><li className="mt-3">for any unlawful purpose;</li><li className="mt-3">to solicit others to perform or participate in any unlawful acts;</li><li className="mt-3">to violate any international, federal, provincial or state regulations,
        rules, laws, or local ordinances;</li><li className="mt-3">to infringe upon or violate our intellectual property rights or the
        intellectual property rights of others;</li><li className="mt-3">to harass, abuse, insult, harm, defame, slander, disparage, intimidate,
        or discriminate based on gender, sexual orientation, religion,
        ethnicity, race, age, national origin, or disability;</li><li className="mt-3">to submit false or misleading information;</li><li className="mt-3">to upload or transmit viruses or any other type of malicious code that
        ...
        the Internet;</li><li className="mt-3">to collect or track the personal information of others;</li><li className="mt-3">to spam, phish, pharm, pretext, spider, crawl, or scrape;</li><li className="mt-3">for any obscene or immoral purpose; or</li><li className="mt-3">to interfere with or circumvent the security features of the Service or
        ...
        violating any of the prohibited uses.</li></ul><h3 className="mt-8 mb-4">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h3><p className="mt-4">We do not guarantee, represent or warrant that your use of our service
      ...
      accurate or reliable.</p><p className="mt-4">You agree that from time to time we may remove the service for indefinite
      ...
      infringement.</p><p className="mt-4">In no case shall The Bidding App, our directors, officers, employees,
      ...
      to the maximum extent permitted by law.</p><h3 className="mt-8 mb-4">SECTION 14 - INDEMNIFICATION</h3><p className="mt-4">You agree to indemnify, defend and hold harmless The Bidding App and
      ...
      third-party.</p><h3 className="mt-8 mb-4">SECTION 15 - SEVERABILITY</h3><p className="mt-4">In the event that any provision of these Terms of Service is determined to
      ...
      enforceability of any other remaining provisions.</p><h3 className="mt-8 mb-4">SECTION 16 - TERMINATION</h3><p className="mt-4">The obligations and liabilities of the parties incurred prior to the
      ...
      cease using our site.</p><p className="mt-4">If in our sole judgment you fail, or we suspect that you have failed, to
      ...
      thereof).</p><h3 className="mt-8 mb-4">SECTION 17 - ENTIRE AGREEMENT</h3><p className="mt-4">The failure of us to exercise or enforce any right or provision of these
      ...
      against the drafting party.</p><h3 className="mt-8 mb-4">SECTION 18 - GOVERNING LAW</h3><p className="mt-4">These Terms of Service and any separate agreements whereby we provide you
      Services shall be governed by and construed in accordance with the laws of
      Iowa, United States.</p><h3 className="mt-8 mb-4">SECTION 19 - CHANGES TO TERMS OF SERVICE</h3><p className="mt-4">You can review the most current version of the Terms of Service at any
      ...
      of Service constitutes acceptance of those changes.</p><h3 className="mt-8 mb-4">SECTION 20 - CONTACT INFORMATION</h3><p>If you have any questions about the Terms of Services, please contact us
      at<Link className="text-blue-dark" href="mailto:adamu.dankore@gmail.com"> Adamu.dankore@gmail.com.</Link></p></div>
