...
function HowToBid() {
  ...
  return (
    <Page margin='mx-2' title='How to Bid'>
      <div className='bg-white shadow-sm lg:rounded-lg max-w-8xl mx-auto py-6 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='my-6 flex justify-center'>
          ...
          <Link to='/' className='block ml-3 items-center justify-center px-4 py-2 border border-gray-200 text-base leading-6 font-medium rounded-md text-blue-600 bg-white hover:bg-gray-100 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out'>
            Browse Projects
          </Link>
        </div>
      </div>
