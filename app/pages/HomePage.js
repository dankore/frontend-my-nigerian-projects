    ...
    <Page title='Home'>
      <div className='mt-2 align-middle inline-block min-w-full'>
        <ul className='flex shadow mb-4'>
          <NavLink to='/home' activeStyle={activeNavCSS} className='cursor-pointer mr-1 bg-white inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold'>
            All Projects: 4
          </NavLink>
