...
function HomePage() {
  ...
  return (
    <div className='align-middle inline-block min-w-full'>
      <SEO image={`https://res.cloudinary.com/my-nigerian-projects/image/upload/v1594487157/mynigerianprojects_scdybp.png`} url={window.location} description={`My Nigerian Projects is a site for posting small projects or finding one.`} title={`Find a side hustle or post one on My Nigerian Projects`}/>
