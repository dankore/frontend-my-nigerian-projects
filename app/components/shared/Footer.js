...
function Footer() {
  ...
  return (
    <div className='text-center mt-10'>
      ...
      {appState && appState.toggleImageViewer && <div onClick={() => appDispatch({ type: 'toggleImageViewer' })} className='modal-overlay bg-black absolute cursor-pointer'><button className='rounded-full shadow-lg text-lg left-0 p-4 bg-white absolute'>X</button></div>}
