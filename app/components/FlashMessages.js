  ...
  return (
    <div className='floating-alerts'>
      {props.messages.map((msg, index) => {
        return (
          <div key={index} className='text-center floating-alert bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-6 py-3 shadow-md'>
            <div className='ml-3'>{msg}</div>
